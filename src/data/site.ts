...
export const site = {
  ...
  description:
    "Kei Sakai — Kunani. Game worlds, local AI tools, and real-time 3D stages. Side Eye, Token Savers, Zork Reborn, CAPTURE! for Quake II, and more.",
